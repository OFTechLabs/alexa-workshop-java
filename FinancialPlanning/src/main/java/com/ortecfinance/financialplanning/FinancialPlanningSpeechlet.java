...
public class FinancialPlanningSpeechlet implements Speechlet {
    ...
    public static String WELCOME_MESSAGE = "Welcome to financial planning. I can help you determine whether your current financial goals are feasible. What is the amount you need to achieve your financial goal?";
    ...
    public SpeechletResponse onIntent(IntentRequest intentRequest, Session session) {
        String text = ResponseTextFactory.create(intentRequest.getIntent().getName(), session, intentRequest.getIntent().getSlots());
